...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/f83ddb23fa0b11ac79ce6.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'https://telegra.ph/file/f83ddb23fa0b11ac79ce6.jpg',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "ᴘᴏᴡᴇʀᴅ ʙʏ Qᴜᴇᴇɴ-ʜᴇʟᴀɴᴋᴀ ▎▎🧡🍃",
    BOT_NAME: process.env.BOT_NAME || '𝗤𝗨𝗘𝗘𝗡-𝗛𝗘𝗟𝗔𝗡𝗞𝗔 ▎▎🧡🍃',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ¹𝙸𝚃𝚉 𝙼𝙴 𝚂𝙰𝙷𝙰𝙽¹ꫂ;Raganork MD https://telegra.ph/file/f83ddb23fa0b11ac79ce6.jpg' : process.env.AUDIO_DATA,
